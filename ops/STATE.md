...
最后更新:2026-07-07(**切片3 北交所排除已裁A(视图层WHERE `!~'\.BJ$'`),五条施工中**:①三视图加排除同holdout焊法②底表不动328忠实存全③核查负面断言三视图.BJ=0+留档排除量④泄漏测试扩.BJ返空⑤600018入档关coverage。毕→改cleaning→接exp_id5→跑#4=第一份真实体检报告。Q3 签收 `ea59367`、切片2 终签 `b7e3b4b`)
