...
> **⚠ 改判(2026-07-28,人裁):本地留存 14 份 → 5 份**。原因=本地明文+密文合计 39G,占 100G 系统盘大头(64%);本地定位为境内快恢复,5 份足够,更早恢复点走 AWS 异地密文。**异地 AWS 30 份不动,仍为最后防线。**下文正文中"本地留 14 份"字样为 07-06 验收时点原文,以本条为准。落地=backup.sh `tail -n +15`→`tail -n +6`(含观澜轮转同改)。
