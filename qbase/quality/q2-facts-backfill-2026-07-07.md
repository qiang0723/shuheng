...
## 挂账(转 caveats-and-ledger.md)

- **C-forecast-null**: forecast_snap 91 行(0.07%)first_ann_date 为 NULL(type='其他',多 2012–13 早期)。#4 锚定 fallback:锚 first_ann_date,为空回退 ann_date 并标注,**不静默**。默认=回退+标注,改动需人拍。
