...
> **部署口径作废（2026-08-09）**：本档关于 Sites 为正式部署机制的结论，已被 John 原文「部署使用docker部署」作废。静态快照、页面内容与本地浏览器验证仍有效；正式部署以 `docs/web-docker-deploy-correction-order-2026-08-09.md` 及后续 Docker 交付档为准。
