...
## §10 范围合规(diff --stat,基=第二轮收口 `8ea6b12`,至 `4fc4663` 代码终)

代码面(taosha+qbase,含本验收档):**16 文件 +1180/−95**
...
全范围(另含 docs/postaudit-round3-narrow-order 留痕与 ops/STATE):18 文件 +1270/−96。
