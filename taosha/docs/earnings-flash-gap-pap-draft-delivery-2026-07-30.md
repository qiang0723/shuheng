...
## 8. 草案复核后人裁（2026-07-30，数据落地前）

裁定原文及完整效力见 `earnings-flash-gap-predata-rulings-2026-07-30.md`：

> A1；ST reject；postpone_policy=unified_announcement，其他沿承项按草案建议确认。

- A1 已在全量 express 与 A1/A2 数量对照出现前裁定；未来并算不得用于改判；
- ST、公告顺延及 §6 其余沿承项均已确认；
- 菜单B与C仍未裁，分别等待全量初始/修订形态和公司公告会计口径抽核；
- 草案 JSON 保持原样，digest 仍为 `b3c992bc…80a39`，不得冒充可冻结终版；
- 下一步只能由 John 另令数据前置闭合，未令不采集、不落库、不施工。
