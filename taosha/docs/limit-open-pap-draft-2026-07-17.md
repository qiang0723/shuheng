...
> **⚠ 状态更新(2026-07-17 深夜二,改判纪律):本档 §2 复核点 C1–C6 已由人回修令裁决
> (留痕 `limit-open-premend-order-2026-07-17.md`),§1 草案 JSON 已被终版取代——
> 终版实物 = `limit-open-pap-final-2026-07-17.json`(sha256 `a6a2da9a…`),
> 交付与裁决落点 = `limit-open-premend-acceptance-2026-07-17.md`。本档保留作草案历史存档。**
