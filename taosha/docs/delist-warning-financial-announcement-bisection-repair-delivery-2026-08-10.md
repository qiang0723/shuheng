...
## 六、v3 单日多页 fail-closed

`s22-ann-index-v3` 于 `2026-08-10 16:07:11+08` 在
`000046.SZ / 2017-04-25` 命中预设硬门“单日仍超过单页”并 exit=`1`；监督链记录
`metadata_v3_exit=1`，后三阶段零启动。停止实物为：

```text
valid_done=10
bisect_v3_reads=320
errors=3
v3_tree_sha256=29ef9951d09c0fbe1b62b9431e5aa3bf2cc4a60ce6d9a14151c4cdde976bba75
metadata_v3_sha256=a3f5de98a15abb5749d6c968c70b2e78aa229bc2ed8a0508e288ce19611fec8e
```

监控按令暂停，未自动重启。该失败证明日期二分能消除跨日边界漂移，但单日内仍存在真实多页
数据面；继续须另批单日双遍完整分页，不得把“单日”当成天然单页。
