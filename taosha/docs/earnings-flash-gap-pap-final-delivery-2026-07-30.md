...
John 于 2026-07-30（UTC+8）逐字确认：

> 菜单B=B1；菜单C=C1。

该原文见 `earnings-flash-gap-pap-final-review-ruling-2026-07-30.md`，补正终版收口令中
以“继续执行”解释 B/C 菜单的留痕缺口；终版 PAP 与 digest 不变。

`event_def` 中“若 A1 最新合格预告日存在多条不同区间则整组 fail-closed”是为使 A1
在该边界下仍具确定性而补入的对称先验规则，不是依据已观测方向或样本数量选择的条款。
snapshot 340 / express 15 实物中，“A1 最新日区间冲突”单独剔除 **0 组**；该 0 组与
B1 所剔除的 6 个多行快报组不是同一漏斗档。
...
零 persist。终版 digest 外部复核及上述留痕补正均已闭合；下一步由 John 亲拟方向与把握度并
另下冻结令。
